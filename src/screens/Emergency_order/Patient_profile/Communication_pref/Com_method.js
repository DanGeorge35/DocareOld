          ...
          <Stack direction="row" space={1}>
            <Box>
              <Box
                ...
                <Image
                  source={require('../../../../../assets/icon_nav/bell1.png')}
                  alt="Alternate Text"
                  size="26"
                />
              </Box>
          ...
          <Stack direction="row" space={1}>
            ...
            <Box>
              ...
              <Text
                ...
                color="#000000">
                {' '}
                Toggle to enable Messages
              </Text>
            </Box>

            <Text position="absolute" right="2">
              {' '}
              <Switch defaultIsChecked colorScheme="info" />
            </Text>
          </Stack>
        </Pressable>
          ...
          <Stack direction="row" space={1}>
            <Box>
              <Box
                ...
                justifyContent="center">
                <Image
                  source={require('../../../../../assets/icon_nav/sms1.png')}
                  alt="Alternate Text"
                  size="26"
                />
              </Box>
