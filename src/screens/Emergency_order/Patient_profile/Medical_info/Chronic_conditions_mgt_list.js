...
const Chronic_conditions_mgt_list = () => {
  return (
    ...
    <Text position="absolute" right="5" top="5" h="40"  > <FontAwesome5 name="plus" size={22} /></Text>
      ...
      <Pressable  bg="#F8F8FF" pl="5" pt="5" pb="0" borderRadius="md" mx="3" mt="12" h="20">
          ...
          <Stack direction="row" space={2}>
              ...
              <Box >
                      <Text fontFamily="GeneralSans-Bold" fontWeight="bold" fontSize="16" lineHeight="20" color="#000000"  >Cancer</Text>

                      <Text fontFamily="GeneralSans-Bold" mt="2" fontWeight="bold" fontSize="13" lineHeight="20" color="#606060"  >February, 2023 - Present</Text>
              </Box>
...
export default Chronic_conditions_mgt_list