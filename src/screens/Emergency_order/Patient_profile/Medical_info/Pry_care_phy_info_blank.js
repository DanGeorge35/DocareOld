...
const Pry_care_phy_info_blank = ({navigation}) => {
  return (
    <VStack space="5"  backgroundColor="#FFFFFF"   flex={1} >
        <Stack px="5"  mt="0" >
            ...
            <Box alignItems="center" mt="30%">
                <Button bg="#1C70EE" borderRadius="md" w="100%" p="4" onPress={()=>navigation.navigate("Pry_care_phy_info")}>
...
export default Pry_care_phy_info_blank