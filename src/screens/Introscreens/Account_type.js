...
<VStack space="2.5"    bg="#ffffff" flex={1} >
    ...
    <Flex w="360" justifyContent="center"  alignItems="center" h="50%"  >
      ...
      <Pressable   >
        ...
        return <Stack direction="row" mb="1" mt="1" space={5}  bg={isPressed ? "coolGray.200" : isHovered ? "coolGray.200" : "coolGray.100"} style={{
          transform: [{
