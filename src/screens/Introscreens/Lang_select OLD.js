      ...
      <LinearGradient
        ...
        <Box mr="0">
          <Text
            ...
            onPress={() => navigation.navigate('Intro_screens')}>
            {' '}
            Language selection
          </Text>
        ...
        <LinearGradient
          ...
          style={styles.rectangle1}></LinearGradient>

        <LinearGradient
          colors={['#1C70EE', '#FFFFFF']}
          start={{x: 0.3, y: 0}}
          end={{x: 1, y: 0}}
          style={styles.rectangle2}></LinearGradient>

        <LinearGradient
          colors={['#1C70EE', '#FFFFFF']}
          start={{x: 0.4, y: 0}}
          end={{x: 1, y: 0}}
          style={styles.rectangle3}></LinearGradient>
