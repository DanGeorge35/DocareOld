...
const Emergency_contact = ({navigation}) => {
  return (
    <VStack space="5" backgroundColor="#FFFFFF"  flex={1} >
            ...
            <Box alignItems="center">
                ...
                <Text  w="251" fontSize="22" textAlign="center" fontWeight="600" color="#000000"  fontFamily="GeneralSans-Bold"> Emergency contact </Text>
...
<FormControl w="100%" maxW="500"   alignItems="center" mt="2">
    ...
    <Box  mb="1" mt="1" mx="3">
      ...
      <Input type="text"  
       ...
       size="md" my="2" variant="outline" placeholder="Name" minWidth="100%" 
    ...
    size="md" my="2"  variant="outline" placeholder="Relationship" minWidth="100%" 
    placeholderTextColor="#1C1B1F"
    ...
    size="md" my="2" borderRadius="md"  variant="outline" placeholder="Phone Number" minWidth="100%" 
